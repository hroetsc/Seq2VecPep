...
seq2vec = read.csv("sequence_repres_w3_d100_seq2vec.csv", stringsAsFactors = F, header = T)
seq2vec.tfidf = read.csv("sequence_repres_w3_d100_seq2vec-TFIDF.csv", stringsAsFactors = F, header = T)
seq2vec.sif = read.csv("sequence_repres_w3_d100_seq2vec-SIF.csv", stringsAsFactors = F, header = T)
...
# tmp
write.csv(seq2vec, file = "sequence_repres_seq2vec_CCR.csv", row.names = F)
write.csv(seq2vec.sif, file = "sequence_repres_seq2vec-TFIDF_CCR.csv", row.names = F)
write.csv(seq2vec.tfidf, file = "sequence_repres_seq2vec-SIF_CCR.csv", row.names = F)
