...
# indices = read.csv("ids_hp_w3.csv", stringsAsFactors = F, header = F)
# 
# weight_matrix = h5read("model_w3_d100/weights.h5", "/embedding/embedding")
...
# tmp !!
# out = "sequence_repres_w3_d100_seq2vec.csv"
# out.tfidf = "sequence_repres_w3_d100_seq2vec-TFIDF.csv"
# out.sif = "sequence_repres_w3_d100_seq2vec-SIF.csv"
