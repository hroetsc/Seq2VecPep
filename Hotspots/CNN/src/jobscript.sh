...
salloc -p gpu -C scratch2 -N 12 -n 12 --tasks-per-node 1 --gpus-per-task=1 --mem-per-gpu=20G -t 02-00:00:00 --job-name='hotspots' --mail-type=ALL --mail-user=hanna.roetschke@mpibpc.mpg.de
scontrol show hostnames $SLURM_JOB_NODELIST

srun --mpi=pmix -o hotspots-%J.out python D_fitModel_v4.py
