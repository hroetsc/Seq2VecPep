...
salloc -p gpu -C scratch2 -N 8 -n 8 --tasks-per-node 1 --gpus-per-task=1 --mem-per-gpu=10G -t 06:00:00 --job-name='hotspots'

scontrol show hostnames $SLURM_JOB_NODELIST

srun --mpi=pmix -o hotspots-%J.out python D_fitModel_v2.py
