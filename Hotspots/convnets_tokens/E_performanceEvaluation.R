...
system("scp -rp hroetsc@transfer.gwdg.de:/usr/users/hroetsc/Hotspots/results/ensemble_prediction.csv results/")
...
prediction = read.csv("results/ensemble_prediction.csv", stringsAsFactors = F)
