...
salloc -p gpu -C scratch2 -N 8 -n 8 --tasks-per-node 1 --gpus-per-task=1 --mem-per-gpu=20G -t 08:00:00 --job-name='hotspots'
...
cp -rf /scratch2/hroetsc/Hotspots/results/ensemble_prediction.csv results/
cp -rf /scratch2/hroetsc/Hotspots/results/model_predictions.csv results/
