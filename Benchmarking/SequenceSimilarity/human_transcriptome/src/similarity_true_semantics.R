...
# GOterms = read.csv("transcriptome/data/GO_terms.csv", stringsAsFactors = F, header = T)
...
# pick relevant GO-terms
GOterms = GOterms[,which(colnames(GOterms) %in% c("go_id", "ensembl_transcript_id_version"))]
