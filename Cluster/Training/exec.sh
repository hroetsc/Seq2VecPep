...
salloc -p gpu -C scratch2 -n 25 --gpus-per-task=1 --mem-per-gpu=30G -t 18:00:00 --mail-type=END --mail-user=hanna.roetschke@mpibpc.mpg.de --job-name='seq2vec'

scontrol show hostnames $SLURM_JOB_NODELIST > nodes.txt
scontrol show hostnames $SLURM_JOB_NODELIST

snakemake --unlock --cores 1
snakemake --jobs 100000 --cores 100000 --cluster "srun --mpi=pmix -o hp_training-%J.out" -R training_w3 --latency-wait 300
