...
salloc -p gpu -C scratch2 -N 12 -n 12 --tasks-per-node 1 --gpus-per-task=1 --mem-per-gpu=10G -t 02-00:00:00

scontrol show hostnames $SLURM_JOB_NODELIST > nodes.txt
scontrol show hostnames $SLURM_JOB_NODELIST

snakemake --unlock --cores 1
snakemake --jobs 100000 --cores 100000 --cluster "srun --mpi=pmix -o hp-subs_v5k_training-%J-%N.out" --latency-wait 300 -R training_w5
